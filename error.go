...
var (
	...
	errNoEmail              = ValidationError(errors.New("You must supply a email"))
	...
	errUsernameExist        = ValidationError(errors.New("That username is taken"))
	...
	errImageURLInvalid  = ValidationError(errors.New("Countn't download image from the URL you provide"))
)
